...
class Myconstat {
  ...
  static String routemain = '/material';
  static String routeled1 = '/led1';
  static String routeled2 = '/led2';
  static String routeled3 = '/led3';
  ...
  static Color red = Color(0xffdb0000);
  static Color grey1 = Color(0xffbdbdbd);
  static Color cyan1 = Color(0xff64ffda);
